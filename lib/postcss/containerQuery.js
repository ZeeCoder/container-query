...
const unit_constants = require('../unit_constants');
    ...
    return function (root) {
        ...
        root.walk((node) => {
            if (node.type === 'rule') {
                ...
                let newContainer = utils.detectContainerDefinition(node);
                if (newContainer !== null) {
...
module.exports = postcss.plugin('postcss-container-query', containerQuery);

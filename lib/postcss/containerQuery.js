...
var _extractContainerUnitStylesFromRule = require('./extractContainerUnitStylesFromRule');

var _extractContainerUnitStylesFromRule2 = _interopRequireDefault(_extractContainerUnitStylesFromRule);
    ...
    return function (root) {
        ...
        root.walk(function ( /** Node */node) {
            if (node.type === 'rule') {
                ...
                var newContainer = (0, _detectContainerDefinition2.default)(node);
                if (newContainer !== null) {
                ...
                if (currentContainerSelector !== null) {
                    ...
                    addStylesToDefaultQuery(getElementRefBySelector(node.selector), (0, _extractContainerUnitStylesFromRule2.default)(node), true);
                }

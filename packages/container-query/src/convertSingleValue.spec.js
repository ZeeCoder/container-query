...
test("single container value should be properly converted to px", () => {
  ...
  expect(convertSingleValue({ width: 15 }, ` 50${WIDTH_UNIT}`)).toBe("7.50px");
  ...
  expect(convertSingleValue({ width: 1200, height: 100 }, `1${MIN_UNIT}`)).toBe(
    "1.00px"
  );

  expect(convertSingleValue({ width: 1200, height: 120 }, `1${MIN_UNIT}`)).toBe(
    "1.20px"
  );
  ...
  expect(convertSingleValue({ width: 900, height: 1200 }, `1${MIN_UNIT}`)).toBe(
    "9.00px"
  );
  ...
  expect(convertSingleValue({ width: 900, height: 1200 }, `1${MAX_UNIT}`)).toBe(
    "12.00px"
  );

  expect(convertSingleValue({ width: 900, height: 1200 }, `2${MAX_UNIT}`)).toBe(
    "24.00px"
  );

  expect(convertSingleValue({ width: 100, height: 99 }, `1${MAX_UNIT}em`)).toBe(
    `1${MAX_UNIT}em`
  );

  expect(convertSingleValue({ width: 120, height: 99 }, `5${MAX_UNIT}em`)).toBe(
    `5${MAX_UNIT}em`
  );
